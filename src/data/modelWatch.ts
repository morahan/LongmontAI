...
export const modelWatchSnapshots: ModelWatchSnapshot[] = [
  ...
  {
    company: 'Z.ai',
    update: 'GLM-5.3-Flash launched as a 320B/18B-active multimodal coding and agent model, with a 50% API promo through 9 Sep 2026 UTC+8.',
    date: 'Aug 26, 2026',
    lane: 'Cheap multimodal agents',
    url: 'https://z.ai/blog/glm-5.3-flash',
  },
  {
    company: 'Alibaba Qwen',
    update: 'Qwen3.8-Flash-Next weights landed as an experimental Qwen4-architecture preview; hosted production is qwen3.8-flash.',
    date: 'Aug 26, 2026',
  ...
  {
    company: 'Google DeepMind',
    update: 'Gemini 3.5 Transcribe and the Gemini 3.5 Audio family entered public preview for live and file speech-to-text.',
    date: 'Aug 26, 2026',
    lane: 'Speech-to-text',
  ...
  {
    company: 'IBM',
    update: 'Granite 4.2 (3B/8B/30B) and Granite Speech 5.0 Turbo CTC shipped as Apache-2.0 local agent and on-device ASR models.',
    date: 'Aug 25, 2026',
    lane: 'Open-weight local agents and speech',
