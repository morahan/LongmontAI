...
const MATRIX: Matrix = {
  ...
  Video: {
    ...
    '3D Models': [{ name: 'Luma (video→3D)', url: 'https://lumalabs.ai' }, { name: 'Meshy video upload', url: 'https://meshy.ai' }, { name: 'Polycam AI', url: 'https://poly.cam' }, { name: 'Nerfstudio (video→3D scene)', url: 'https://docs.nerf.studio/' }],
