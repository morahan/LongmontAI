...
const MATRIX: Matrix = {
  Text: {
    Text: [{ name: 'Claude Opus 5', url: 'https://www.anthropic.com/news/claude-opus-5' }, { name: 'Qwen3.8-Max', url: 'https://www.alibabacloud.com/blog/alibaba-unveils-qwen3-8-max-its-largest-and-most-capable-flagship-model-to-date_603420' }, { name: 'DeepSeek-V4-Flash-0731', url: 'https://api-docs.deepseek.com/updates/' }, { name: 'Grok 4.5', url: 'https://x.ai/grok' }, { name: 'Claude Fable 5', url: 'https://anthropic.com/claude' }, { name: 'GPT-5.6 Sol', url: 'https://openai.com/gpt-5-6' }, { name: 'Gemini 3.1 Pro', url: 'https://deepmind.google/gemini' }],
