...
export const chineseModelReleases: ChineseModelRelease[] = [
    ...
    { date: '2026-07-31', provider: 'MiniMax', release: 'MiniMax H3', source: 'Official MiniMax release page', sourceUrl: 'https://www.minimax.io/blog/minimax-h3' },
    ...
    { date: '2026-07-31', provider: 'DeepSeek', release: 'DeepSeek-V4-Flash-0731', source: 'Official DeepSeek API changelog', sourceUrl: 'https://api-docs.deepseek.com/updates/' },
    ...
    { date: '2026-07-16', provider: 'Moonshot / Kimi', release: 'Kimi K3', source: 'Official Moonshot model card and weights', sourceUrl: 'https://huggingface.co/moonshotai/Kimi-K3' },
    ...
    { date: '2026-08-03', provider: 'Alibaba / Qwen', release: 'Qwen3.8-Max', source: 'Official Alibaba Cloud release', sourceUrl: 'https://www.alibabacloud.com/blog/alibaba-unveils-qwen3-8-max-its-largest-and-most-capable-flagship-model-to-date_603420' },
    { date: '2026-08-26', provider: 'Alibaba / Qwen', release: 'Qwen3.8-Flash-Next', source: 'Official Qwen model card', sourceUrl: 'https://huggingface.co/Qwen/Qwen3.8-Flash-Next' },
    ...
    { date: '2026-08-26', provider: 'Zhipu / GLM', release: 'GLM-5.3-Flash', source: 'Official Z.ai release', sourceUrl: 'https://z.ai/blog/glm-5.3-flash' },
