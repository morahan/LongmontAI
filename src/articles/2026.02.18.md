...
*Data sources: SWE-bench Official Leaderboard (Feb 17, 2026), Kimi K2.5 launch benchmarks (Jan 27, 2026), METR benchmarks, Moonshot AI, Gemini AI, MoltMatch, public API pricing pages. All SWE-bench standardized results use mini-SWE-agent v2.0. Screenshots captured February 2026.*
