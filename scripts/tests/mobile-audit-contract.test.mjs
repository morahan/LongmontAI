...
const [packageJson, localCi, preCommit, prePush, runner, audit, editorGuide] = await Promise.all([
...
assert.match(editorGuide, /pre-commit, pre-push, and full local-CI paths/);
